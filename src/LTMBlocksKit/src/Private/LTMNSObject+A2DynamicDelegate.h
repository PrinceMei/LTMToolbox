//
//  LTMNSObject+A2DynamicDelegate.h
//  BlocksKit
//
...
/** The LTMA2DynamicDelegateAdditions category to NSObject provides the primary interface
 by which dynamic delegates are generated for a given object. */
@interface NSObject (LTMA2DynamicDelegateAdditions)
 ...
 */
@property (readonly, strong) id ltm_dynamicDataSource;
 ...
 */
@property (readonly, strong) id ltm_dynamicDelegate;
