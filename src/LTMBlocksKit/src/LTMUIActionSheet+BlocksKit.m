...
@interface LTMA2DynamicUIActionSheetDelegate : LTMA2DynamicDelegate <UIActionSheetDelegate>

@property (nonatomic, assign) BOOL didHandleButtonClick;

@end

@implementation LTMA2DynamicUIActionSheetDelegate
...
- (void)ltm_setHandler:(void (^)(void))block forButtonAtIndex:(NSInteger)index {
	LTMA2DynamicUIActionSheetDelegate *delegate = self.ltm_ensuredDynamicDelegate;
