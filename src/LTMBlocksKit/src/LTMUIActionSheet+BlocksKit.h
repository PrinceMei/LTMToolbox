 ...
 */
+ (instancetype)ltm_actionSheetWithTitle:(NSString *)title LTM_BK_ALERT_CONTROLLER_DEPRECATED(2_0);
 ...
 */
- (instancetype)ltm_initWithTitle:(NSString *)title LTM_INITIALIZER LTM_BK_ALERT_CONTROLLER_DEPRECATED(2_0);
...
/** Set the destructive (red) button with an associated code block.
 ...
 @param block A block of code.
 */
- (NSInteger)ltm_setDestructiveButtonWithTitle:(NSString *)title handler:(void (^)(void))block LTM_BK_ALERT_CONTROLLER_DEPRECATED(2_0);
...
@property (nonatomic, copy, setter = ltm_setWillShowBlock:) void (^ltm_willShowBlock)(UIActionSheet *actionSheet) LTM_BK_ALERT_CONTROLLER_DEPRECATED(2_0);

/** The block to be fired when the action sheet shows. */
@property (nonatomic, copy, setter = ltm_setDidShowBlock:) void (^ltm_didShowBlock)(UIActionSheet *actionSheet) LTM_BK_ALERT_CONTROLLER_DEPRECATED(2_0);

/** The block to be fired before the action sheet will dismiss. */
@property (nonatomic, copy, setter = ltm_setWillDismissBlock:) void (^ltm_willDismissBlock)(UIActionSheet *actionSheet, NSInteger buttonIndex) LTM_BK_ALERT_CONTROLLER_DEPRECATED(2_0);

/** The block to be fired after the action sheet dismisses. */
@property (nonatomic, copy, setter = ltm_setDidDismissBlock:) void (^ltm_didDismissBlock)(UIActionSheet *actionSheet, NSInteger buttonIndex) LTM_BK_ALERT_CONTROLLER_DEPRECATED(2_0);
