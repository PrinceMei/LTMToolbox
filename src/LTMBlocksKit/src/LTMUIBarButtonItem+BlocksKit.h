//
//  LTMUIBarButtonItem+BlocksKit.h
//  LTMBlocksKit
//
 ...
 */
@interface UIBarButtonItem (LTMUIBarButtonItemBlocksAdditions)
 ...
 */
- (instancetype)ltm_initWithBarButtonSystemItem:(UIBarButtonSystemItem)systemItem handler:(void (^)(id sender))action LTM_INITIALIZER;
...
/** Creates and returns a configured item using the specified image and style.
 ...
 @param action The block that gets fired on the button press.
 */
- (instancetype)ltm_initWithImage:(UIImage *)image style:(UIBarButtonItemStyle)style handler:(void (^)(id sender))action LTM_INITIALIZER;
...
/** Creates and returns a configured item using the specified image and style.
 ...
 @param action The block that gets fired on the button press.
 */
- (instancetype)ltm_initWithImage:(UIImage *)image landscapeImagePhone:(UIImage *)landscapeImagePhone style:(UIBarButtonItemStyle)style handler:(void (^)(id sender))action LTM_INITIALIZER;
...
/** Creates and returns a configured item using the specified text and style.
 ...
 @param action The block that gets fired on the button press.
 */
- (instancetype)ltm_initWithTitle:(NSString *)title style:(UIBarButtonItemStyle)style handler:(void (^)(id sender))action LTM_INITIALIZER;
