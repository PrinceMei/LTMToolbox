 ...
 */
@interface UITextField (LTMUITextFieldBlocksAdditions)
 ...
 */
@property (nonatomic, copy, nullable) BOOL(^ltm_shouldBeginEditingBlock)(UITextField *textField);

/**
 *	The block that fires after the receiver begins editing
 */
@property (nonatomic, copy, nullable) void(^ltm_didBeginEditingBlock)(UITextField *textField);
 ...
 */
@property (nonatomic, copy, nullable) BOOL(^ltm_shouldEndEditingBlock)(UITextField *textField);

/**
 *	The block that fires after the receiver ends editing
 */
@property (nonatomic, copy, nullable) void(^ltm_didEndEditingBlock)(UITextField *textField);
 ...
 */
@property (nonatomic, copy, nullable) BOOL(^ltm_shouldChangeCharactersInRangeWithReplacementStringBlock)(UITextField *textField, NSRange range, NSString *string);
 ...
 */
@property (nonatomic, copy, nullable) BOOL(^ltm_shouldClearBlock)(UITextField *textField);
 ...
 */
@property (nonatomic, copy, nullable) BOOL(^ltm_shouldReturnBlock)(UITextField *textField);
