...
typedef __nonnull id <NSObject, NSCopying> LTMBKCancellationToken;
 ...
 */
- (LTMBKCancellationToken)ltm_performAfterDelay:(NSTimeInterval)delay usingBlock:(void (^)(id obj))block;
...
/** Executes a block after a given delay.
 ...
 @return An opaque, temporary token that may be used to cancel execution.
 */
+ (LTMBKCancellationToken)ltm_performAfterDelay:(NSTimeInterval)delay usingBlock:(void (^)(void))block;
...
/** Executes a block in the background after a given delay on the receiver.
 ...
 @return An opaque, temporary token that may be used to cancel execution.
 */
- (LTMBKCancellationToken)ltm_performInBackgroundAfterDelay:(NSTimeInterval)delay usingBlock:(void (^)(id obj))block;
...
/** Executes a block in the background after a given delay.
 ...
 @return An opaque, temporary token that may be used to cancel execution.
 */
+ (LTMBKCancellationToken)ltm_performInBackgroundAfterDelay:(NSTimeInterval)delay usingBlock:(void (^)(void))block;
...
/** Executes a block in the background after a given delay.
 ...
 @return An opaque, temporary token that may be used to cancel execution.
 */
- (LTMBKCancellationToken)ltm_performOnQueue:(dispatch_queue_t)queue afterDelay:(NSTimeInterval)delay usingBlock:(void (^)(id obj))block;
...
/** Executes a block in the background after a given delay.
 ...
 @return An opaque, temporary token that may be used to cancel execution.
 */
+ (LTMBKCancellationToken)ltm_performOnQueue:(dispatch_queue_t)queue afterDelay:(NSTimeInterval)delay usingBlock:(void (^)(void))block;
...
/** Cancels the potential execution of a block.
 ...
 methods.
 */
+ (void)ltm_cancelBlock:(LTMBKCancellationToken)token;
