...
#import "LTMTelephonyNetworkInfo.h"
...
@interface LTMTelephonyNetworkInfo ()

@property (nonatomic, assign, readwrite) LFRadioAccessTechnologyGroup radioAccessTechnologyGroup;

@end

@implementation LTMTelephonyNetworkInfo {
    CTTelephonyNetworkInfo *_internalInfo;
}

+ (instancetype)currentInfo {
    static LTMTelephonyNetworkInfo *g_telephonyNetworkInfo = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        g_telephonyNetworkInfo = [[LTMTelephonyNetworkInfo alloc] _init];
    });
