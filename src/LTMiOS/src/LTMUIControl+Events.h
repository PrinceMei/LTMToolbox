 ...
 */
@interface UIControl (LTMUIControlEventsAdditions)
...
/**
 ...
 @param controlEvents  A bitmask specifying the control events for which the
                       action message is sent.
 */
- (void)ltm_addBlockForControlEvents:(UIControlEvents)controlEvents block:(void (^)(id sender))block;
...
/**
 ...
 @param controlEvents  A bitmask specifying the control events for which the
                       action message is sent.
 */
- (void)ltm_setBlockForControlEvents:(UIControlEvents)controlEvents block:(void (^)(id sender))block;
