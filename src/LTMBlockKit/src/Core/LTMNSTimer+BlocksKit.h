...
*/
@interface NSTimer (LTMNSTimerBlocksAdditions)
 ...
 * @return A new @c NSTimer object, configured according to the specified parameters.
 */
+ (instancetype)ltm_timerWithTimeInterval:(NSTimeInterval)seconds repeats:(BOOL)repeats usingBlock:(void (^)(NSTimer *timer))block;

@end

@interface NSTimer (LTMNSTimerBlocksAdditions_Deprecated)

+ (instancetype)ltm_scheduledTimerWithTimeInterval:(NSTimeInterval)seconds block:(void (^)(NSTimer *timer))block repeats:(BOOL)repeats DEPRECATED_MSG_ATTRIBUTE("Replaced with -bk_performAfterDelay:usingBlock:");
+ (instancetype)ltm_timerWithTimeInterval:(NSTimeInterval)seconds block:(void (^)(NSTimer *timer))block repeats:(BOOL)repeats DEPRECATED_MSG_ATTRIBUTE("Replaced with -bk_performAfterDelay:usingBlock:");
