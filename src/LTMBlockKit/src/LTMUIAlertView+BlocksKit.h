 ...
 */
+ (instancetype)ltm_showAlertViewWithTitle:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles handler:(void (^)(UIAlertView *alertView, NSInteger buttonIndex))block LTM_ALERT_CONTROLLER_DEPRECATED(2_0);
 ...
 */
+ (instancetype)ltm_alertViewWithTitle:(NSString *)title LTM_ALERT_CONTROLLER_DEPRECATED(2_0);
...
/** Creates and returns a new alert view with only a title, message, and cancel button.
 ...
 @return A newly created alert view.
 */
+ (instancetype)ltm_alertViewWithTitle:(NSString *)title message:(NSString *)message LTM_ALERT_CONTROLLER_DEPRECATED(2_0);
 ...
 */
- (instancetype)ltm_initWithTitle:(NSString *)title message:(NSString *)message BK_INITIALIZER LTM_ALERT_CONTROLLER_DEPRECATED(2_0);
 ...
 */
- (NSInteger)ltm_addButtonWithTitle:(NSString *)title handler:(void (^)(void))block LTM_ALERT_CONTROLLER_DEPRECATED(2_0);
...
/** Set the title and trigger of the cancel button.
 ...
 @param block A block of code.
 */
- (NSInteger)ltm_setCancelButtonWithTitle:(NSString *)title handler:(void (^)(void))block LTM_ALERT_CONTROLLER_DEPRECATED(2_0);
 ...
 */
- (void)ltm_setHandler:(void (^)(void))block forButtonAtIndex:(NSInteger)index LTM_ALERT_CONTROLLER_DEPRECATED(2_0);
 ...
 */
- (void (^)(void))ltm_handlerForButtonAtIndex:(NSInteger)index LTM_ALERT_CONTROLLER_DEPRECATED(2_0);
...
/** The block to be fired when the action sheet is dismissed with the cancel
 ...
 not be generated.
 */
@property (nonatomic, copy, setter = ltm_setCancelBlock:) void (^ltm_cancelBlock)(void) LTM_ALERT_CONTROLLER_DEPRECATED(2_0);

/** The block to be fired before the alert view will show. */
@property (nonatomic, copy, setter = ltm_setWillShowBlock:) void (^ltm_willShowBlock)(UIAlertView *alertView) LTM_ALERT_CONTROLLER_DEPRECATED(2_0);

/** The block to be fired when the alert view shows. */
@property (nonatomic, copy, setter = ltm_setDidShowBlock:) void (^ltm_didShowBlock)(UIAlertView *alertView) LTM_ALERT_CONTROLLER_DEPRECATED(2_0);

/** The block to be fired before the alert view will dismiss. */
@property (nonatomic, copy, setter = ltm_setWillDismissBlock:) void (^ltm_willDismissBlock)(UIAlertView *alertView, NSInteger buttonIndex) LTM_ALERT_CONTROLLER_DEPRECATED(2_0);

/** The block to be fired after the alert view dismisses. */
@property (nonatomic, copy, setter = ltm_setDidDismissBlock:) void (^ltm_didDismissBlock)(UIAlertView *alertView, NSInteger buttonIndex) LTM_ALERT_CONTROLLER_DEPRECATED(2_0);

/** The block to be fired to determine whether the first non-cancel should be enabled */
@property (nonatomic, copy, setter = ltm_SetShouldEnableFirstOtherButtonBlock:) BOOL (^ltm_shouldEnableFirstOtherButtonBlock)(UIAlertView *alertView) LTM_ALERT_CONTROLLER_DEPRECATED(5_0);
