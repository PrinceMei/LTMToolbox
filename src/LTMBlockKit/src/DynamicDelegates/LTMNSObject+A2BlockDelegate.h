 ...
 */
@interface NSObject (LTMNSObjectA2BlockDelegateAdditions)
 ...
 */
+ (void)ltm_linkDataSourceMethods:(NSDictionary *)selectorsForPropertyNames;
 ...
 */
+ (void)ltm_linkDelegateMethods:(NSDictionary *)selectorsForPropertyNames;
...
/** Synthesizes multiple properties and links them to the appropriate selector
 ...
 selector strings as objects.
 */
+ (void)ltm_linkProtocol:(Protocol *)protocol methods:(NSDictionary *)selectorsForPropertyNames;
...
/** Creates or gets a dynamic delegate, assuring that it is the delegate.
 @see ltm_dynamicDelegate:
 @return A dynamic delegate.
 */
@property (NS_NONATOMIC_IOSONLY, readonly, strong) id ltm_ensuredDynamicDelegate;
...
/** Creates or gets a dynamic protocol implementation, assuring that it is
 ...
 @see ltm_dynamicDelegateForProtocol:
 @return A dynamic delegate.
 */
